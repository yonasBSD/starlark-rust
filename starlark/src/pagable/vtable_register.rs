...
///
/// ```ignore
/// // For a frozen type FrozenMyData:
/// register_any_complex_frozen!(FrozenMyData);
/// ```
#[macro_export]
macro_rules! register_any_complex_frozen {
    ($frozen_type:ty) => {
        // SAFETY: This impl is generated by the registration macro which
        // ensures the vtable is properly registered below.
        unsafe impl $crate::values::any_complex::FrozenAnyComplexRegistered for $frozen_type {}

        $crate::register_simple_vtable_entry!(
            $crate::values::any_complex::StarlarkAnyComplex<$frozen_type>
        );
    };
}
...
macro_rules! register_starlark_any {
    ($type:ty) => {
        // SAFETY: This impl is generated by the registration macro which
        // ensures the vtable is properly registered below.
        unsafe impl $crate::values::any::StarlarkAnyRegistered for $type {}

        $crate::register_simple_vtable_entry!($crate::values::any::StarlarkAny<$type>);
    };
}
